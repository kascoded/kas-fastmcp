...
def notion_query_database(
    ...
    """
    Query a Notion database (API 2022-06-28). Returns raw Notion JSON.
    """
...
def notion_query_data_source(
    ...
    """
    Query a Notion data source (API 2025-09-03). Returns raw Notion JSON.
    """
...
# Optional for local runs; Cloud ignores __main__
